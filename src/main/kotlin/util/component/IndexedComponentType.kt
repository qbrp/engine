...
abstract class IndexedComponentType<T : Component>(final override val id: String) : ComponentType<T> {
...
class EngineComponentType<T : Component>(
    id: String
) : IndexedComponentType<T>(id) {
